...
function getDefaultWeb3() {
  ...
  web3.eth.defaultAccount = process.env.ETH_ACCOUNT || process.env.ETH_FROM || web3.eth.coinbase
...
var address = args[0] || process.env.FEED_ADDRESS;
var get_from = args[1] || "1";

if (!address || !web3.isAddress(address)) {
  console.log('Send a valid address as the first argument');
  process.exit(1);
}
